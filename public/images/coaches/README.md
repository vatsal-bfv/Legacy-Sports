...
| `elijah-wilkinson.jpg` | Elijah Wilkinson |
| `mohamed-sanu.jpg` | Mohamed Sanu (Coach Mo) |
...
public/images/coaches/elijah-wilkinson.jpg
public/images/coaches/mohamed-sanu.jpg
```

## Tips

- Prefer consistent lighting and a similar crop (head + shoulders) across all six photos.
