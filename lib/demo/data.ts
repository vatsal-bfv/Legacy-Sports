...
export const locations: Location[] = [
  {
    ...
    name: "Phoenix",
    slug: "phoenix",
    address: "2847 N 32nd St, Phoenix, AZ 85018",
    lat: 33.48,
    lng: -112.01,
    square_footage: 42000,
    amenities: ["turf", "weight room", "recovery", "indoor track"],
    photo_urls: [
  ...
  },
  {
    ...
    name: "Mesa",
    slug: "mesa",
    address: "1855 S Val Vista Dr, Mesa, AZ 85204",
    lat: 33.38,
    lng: -111.75,
    square_footage: 35000,
    amenities: ["turf", "weight room", "basketball courts"],
    photo_urls: [
  ...
  },
  {
    ...
    name: "Gilbert",
    slug: "gilbert",
    address: "1420 N Cooper Rd, Gilbert, AZ 85233",
    lat: 33.35,
    lng: -111.79,
    square_footage: 28000,
    amenities: ["turf", "weight room", "soccer fields"],
    photo_urls: [
  ...
  },
  {
    ...
    name: "Scottsdale",
    slug: "scottsdale",
    address: "8765 E Frank Lloyd Wright Blvd, Scottsdale, AZ 85260",
    lat: 33.58,
    lng: -111.89,
    square_footage: 38000,
    amenities: ["turf", "weight room", "recovery", "film room"],
    photo_urls: [
  ...
  },
  {
    ...
    name: "Chandler",
    slug: "chandler",
    address: "3100 W Chandler Blvd, Chandler, AZ 85226",
    lat: 33.31,
    lng: -111.88,
    square_footage: 32000,
    amenities: ["turf", "weight room", "volleyball courts"],
    photo_urls: [
...
export const publicAthletes = heroAthletes
  .filter((a) =>
    ([HERO_IDS.marcus, HERO_IDS.deshawn, HERO_IDS.sofia] as string[]).includes(
      a.id
    )
  )
  .map((a) => ({
    ...
    story:
      a.id === HERO_IDS.deshawn
        ? "From overlooked to two D1 offers in 12 months."
        : a.id === HERO_IDS.marcus
          ? "QB prospect with elite measurable trajectory."
          : "Multi-sport phenom with 4.0 GPA.",
    slug: a.first_name.toLowerCase(),
  }));
