...
export default function CommandCenterPage() {
  const atRisk = demoStore.athletes.filter((a) => a.status === "at_risk");
  const recentLeads = demoStore.leads.slice(0, 5);
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-[#9DA3AE]">Here&apos;s what needs your attention today.</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-[#2A2D34] bg-[#15171B] p-6">
          ...
          <ul className="space-y-2 text-sm">
            {demoStore.sessions.slice(0, 6).map((s) => {
