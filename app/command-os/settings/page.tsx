            ...
            <ul className="space-y-2 text-sm">
              {demoStore.locations.map((l) => (
                <li key={l.id} className="flex justify-between">
                  <span>{l.name}</span>
                  <span className="text-[#9DA3AE]">{l.phone}</span>
                </li>
              ))}
            </ul>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-[#9DA3AE]">API key optional</span>
            </div>
            <div className="flex justify-between">
              <span>Supabase Realtime</span>
              <span className="text-[#9DA3AE]">Poll fallback active</span>
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent className="text-sm text-[#9DA3AE]">
